...
- `COMBAT_REVAMP_SUMMARY.md` - Major combat system overhaul
- `COMBAT_SIMULATION_IMPROVEMENTS.md` - Simulation enhancements
- `COMBAT_SYSTEM_ARCHITECTURE.txt` - Original architecture design
- `COMBAT_TUNING_GUIDE.md` - Parameter tuning guide
- `COMBAT_ENGAGEMENT_FIX_SUMMARY.md` - Engagement mechanics fixes
- `COMBAT_COOPERATIVE_IMPROVEMENTS.md` - Cooperative behavior additions
- `ENHANCED_COMBAT_DOCUMENTATION.md` - Enhanced combat features
...
- `GENETICS_REFACTORING_SUMMARY.md` - Genetics system refactor
- `GENETICS_BREEDING_ARCHITECTURE.md` - Architecture overview
- `BREEDING_FIX_SUMMARY.md` - Breeding system fixes
- `BREEDING_FIX_VISUAL.md` - Visual breeding improvements
...
- `OPTIMIZATION_SUMMARY.md` - General optimizations
...
- `AGENT_SPECIFICATION.md` - Agent role specifications
